...
public class Rational {
	...
	public static void main(String[] args) {
		...
		{
			try{
				System.out.println("Bitte geben sie den Zaehler für die erste Zahl ein:");
				z=In.readLong();
				System.out.println("Bitte geben sie den Nenner für die erste Zahl ein:");
				n=In.readLong();
				a=new Rational(z,n);
				System.out.println("Bitte geben sie den Zaehler für die zweite Zahl ein:");
				z=In.readLong();
				System.out.println("Bitte geben sie den Nenner für die zweite Zahl ein:");
				n=In.readLong();
				b=new Rational(z,n);
				...
				System.out.println("Bis jtzt erzeugte größte Zahl: "+Rational.getMax());
				System.out.println();
				System.out.println();
				System.out.println();
			}
